...
namespace easyERP
{
    public partial class selectMemer_Form : Form
    {
        //連線
        ...
        public selectMemer_Form()
        {
            InitializeComponent();
        }


        private void SelectMemer_Form_FormClosed(object sender, FormClosedEventArgs e)
        {

        }

        private void SelectMemer_Form_Load_1(object sender, EventArgs e)
        {

            //設定標題的底色為透明標題
            label_title_one.BackColor = Color.Transparent;
            label_title_one.Parent = pictureBox_one;

            label_title_two.BackColor = Color.Transparent;
            label_title_two.Parent = pictureBox_one;

            label_title_three.BackColor = Color.Transparent;
            label_title_three.Parent = pictureBox_one;

            label_title_four.BackColor = Color.Transparent;
            label_title_four.Parent = pictureBox_one;
        ...
        //{
        //    //取得欄位值
        //    string value = select_dataGridView.Rows[e.RowIndex].Cells[e.ColumnIndex + 1].Value.ToString();
        //}


        private void Select_dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void MemberBindingSource1_CurrentChanged(object sender, EventArgs e)
        {
